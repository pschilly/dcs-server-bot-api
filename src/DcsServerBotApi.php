...
class DcsServerBotApi
{
    ...
    */
     ...
     * @return array as json
     */
    public static function getTopKills(?string $server_name, ?int $limit, ?int $offset): array
    {
     ...
     * @return array as json
     */
    public static function getTraps(?string $server_name, string $nick, ?int $limit = null, ?int $offset = null, ?string $date = null): array
    {
